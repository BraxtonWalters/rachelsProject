...
var holidayNotices = [
  {
    startDate: getEstDate(new Date(2026, 0, 13, 9)), // January 13, 2026 @ 9 am
    endDate: getEstDate(new Date(2026, 0, 16, 17)), // January 16, 2025 @ 5 pm
    message:
  ...
  {
    startDate: getEstDate(new Date(2026, 0, 16, 17)), // January 16, 2025 @ 5 pm
    endDate: getEstDate(new Date(2026, 0, 20, 7)), // January 20, 2026 @ 7 am
    message:
...
function updateHoursAndNotices() {
  ...
  if (override.isOverride) {
    if (
      ...
      message =
        "Open today: " + timeFormatter(override.startHour, override.endHour);
    } else {
      message = "Closed";
      isAfterHours = true;
    }
